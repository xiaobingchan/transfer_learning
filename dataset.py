...
class Garbage_Loader(Dataset):
    ...
    def get_images(self, csv_path):
        ...
        labels_kinds = train_df.label.unique().tolist() # ['plastic', 'paper', 'cardboard', 'trash', 'glass', 'metal']
        images_path = ["./data/train/" + i for i in files]
...
if __name__ == "__main__":
    train_dataset = Garbage_Loader("./data/train.csv", True)
