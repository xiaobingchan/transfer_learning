...
def train(train_loader, model, criterion, optimizer, epoch, writer):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        [prec1, prec5], class_to = accuracy(output, target, topk=(1, 2))#改topk=(1, 类-1)
...
if __name__ == "__main__":
    # -------------------------------------------- step 1/4 : 加载数据 ---------------------------
    train_dir_list = "./data/train.csv"
    valid_dir_list = "./data/train.csv"
    batch_size = 2
    epochs = 150
    num_classes = 3#num_classes=几个类
